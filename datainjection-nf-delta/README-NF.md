...
Este diretorio e apenas o delta sobre o plugin oficial
`pluginsGLPI/datainjection`, branch `10.0/bugfixes`. Ele nao e um plugin
instalavel sozinho.

Para aplicar em outra instalacao, compare e mescle estes arquivos com a pasta
`datainjection` existente. Evite simplesmente sobrescrever os tres arquivos
originais caso o plugin da empresa ja possua customizacoes.
...
- O campo `PDF da NF` aparece apenas para modelos cujo tipo principal aceita
