...
class PluginDatainjectionEngine
{
   ...
   **/
    ...
    /**
     * Mark a line as failed when post-injection processing throws an error.
     *
     * @param array $line Original imported line
     *
     * @return void
     */
    public function addLineInError(array $line): void
    {
        $this->error_lines[] = $line;
    }
}
